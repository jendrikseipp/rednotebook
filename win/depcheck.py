...
def get_args():
    ...
    parser.add_argument(
        "--root", default=sys.prefix, help="root directory where the recursive check begins")
    parser.add_argument("--delete", action="store_true", help="delete unneeded files")
    return parser.parse_args()


def main():
    args = get_args()
    libs = get_things_to_delete(args.root)
