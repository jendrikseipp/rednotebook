...
@pytest.mark.parametrize("markup,expected_xhtml", [
    ('Simple [named reference 2019-08-01]', 'Simple <a href="notebook:2019-08-01">named reference</a>'),
    ('An inline 2019-08-01 date', 'An inline <a href="notebook:2019-08-01">2019-08-01</a> date'),
    ('2019-10-20 is first', '<a href="notebook:2019-10-20">2019-10-20</a> is first'),
    ('(2019-10-20)', '(<a href="notebook:2019-10-20">2019-10-20</a>)')
])
